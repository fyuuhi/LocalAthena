...
INPUT_LIST="../short_Jpsi_PGE_d1534.list"
#INPUT_RDO_FOR_OUTPUT="user.yfukuhar.mc16_13TeV.Zmumu"
#OUTPUT_AOD=$INPUT_RDO_FOR_OUTPUT".AOD."$DATE".root"
TEMP_RUN_SCRIPT="tmp_run_reco_rdo_to_aod_22.sh"
#MAXEVENTS='100'
LABEL=DIR_RDO_FTK_22
...
if [ -f "$INPUT_LIST" ] ; then
  ...
  do
    ...
    cp ../*.py $DIR
    cd $DIR
    sed -i -e "10i  \ \ --inputRDOFile $INPUT_FILE \ \\\\" $TEMP_RUN_SCRIPT
    echo "=========================="
    bsub -n 2 -q 1d -o log_out ./tmp_run_reco_rdo_to_aod_22.sh
    echo "=========================="
    echo ""
