...
print("success config.py include")
...
opt.doEmptyMenu = True;
opt.doBphysicsSlice = True;

if opt.doEmptyMenu is True:
  print('doEmptyMenu = True')
else:
  print('doEmptyMenu = False')

if opt.doBphysicsSlice is True:
  print('doBphysicsSlice = True')
else:
  print('doBphysicsSlice = False')
